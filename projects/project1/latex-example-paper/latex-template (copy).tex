...
\begin{abstract}
  With this project we will show one practical approach to machine learning
  theory. Our goal was to find a prediction model for the Higg's Boson contest 
  on kaggle, from a set of features and parameters define wether it's a 
  'b' or a 's'. 
\end{abstract}
